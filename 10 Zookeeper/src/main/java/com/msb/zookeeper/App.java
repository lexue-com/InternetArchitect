    ...
    public static void main( String[] args ) throws Exception {
        ...
        final ZooKeeper zk = new ZooKeeper("192.168.150.11:2181,192.168.150.12:2181,192.168.150.13:2181,192.168.150.14:2181",
            ...
            public void process(WatchedEvent event) {
                ...
                System.out.println("new zk event.getState(): "+ state.toString());
                System.out.println("new zk event.getType(): "+ type.toString());
        ...
        System.out.println("new zk over zk.getState(): "+ state.toString());
        ...
        byte[] nodeData = zk.getData("/ooxx", new Watcher() {
        ...
        zk.getData("/ooxx", false, new AsyncCallback.DataCallback() {
            public void processResult(int rc, String path, Object ctx, byte[] data, Stat stat) {
                ...
                System.out.println("回调方法返回的上下文："+ctx.toString());
                System.out.println("回调方法返回的数据："+new String(data));
            }
        },"abc");
